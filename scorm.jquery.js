...
/* ===========================================================
    SCORM JQUERY - Nilo César  - 28/01/2015
                    ...
                    atualizado - 13/10/2015 - Quit Otimizado
/* =========================================================== */
...
(function ($) {
    ...
    BASE.Set_score = function (_raw) {
        ...
        if (Math.round(_raw) <= 100) {
            ...
            BASE.debug("Alerta: O raw(score) deve ser gravado em porcentagem pelo scorm que vão de 0 a 100%, seu calculo ultrapassou esse valor. - " + Math.round(_raw));
        }

        BASE.debug("porcentagem" + Math.round(_raw));
    }
    ...
    BASE.ComputeTime = function () {
        ...
        BASE.debug("currentDate " + formattedTime);
    ...
    BASE.controlInit = function () { //TODO: 13/10/2015
        if (BASE.SCORM.inLMS) {
